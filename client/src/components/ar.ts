...
export const arSA: LocalizationResource = {
  ...
  maintenanceMode:
    'نحن نقوم بعمل بعض التعديلات في الوقت الحالي. سوف نعود في غضون دقائق قليلة',
  ...
  organizationProfile: {
    ...
    profilePage: {
      dangerSection: {
        ...
        leaveOrganization: {
          ...
          messageLine1:
            'هل أنت متاكد أنك تريد الخروج من المنظمة؟ سوف تفقد الصلاحيات لهذه المنظمة وجميع تطبيقاتها',
          messageLine2: 'هذا القرار نهائي ولا يمكن التراجع عنه.',
    ...
    removeDomainPage: {
      ...
      messageLine2:
        'لن يتمكن المستخدمون من الانضمام إلى المؤسسة تلقائيًا بعد ذلك.',
    ...
    verifiedDomainPage: {
      ...
      enrollmentTab: {
        ...
        manualInvitationOption__description:
          'يمكن دعوة المستخدمين يدويًا فقط للمؤسسة.',
        manualInvitationOption__label: 'لا يوجد تسجيل تلقائي',
        subtitle:
          'أختر كيف يمكن للمستخدمين في هذا النطاق تسجيل الدخول إلى المنظمة',
      },
      start: {
  ...
  signIn: {
    ...
    emailLink: {
      clientMismatch: {
        subtitle:
          'للمتابعة, قم بفتح رابط التحقق عبر نفس الجهاز والمتصفح الذي انشأت محاولة تسجيل الدخول منه',
    ...
    resetPassword: {
      ...
      successMessage:
        'تم تغيير كلمة المرور بنجاح. يتم تسجيل الدخول الرجاء الأنتظار قليلا.',
  ...
  signUp: {
    ...
    emailLink: {
      clientMismatch: {
        subtitle:
          'للمتابعة، افتح رابط التحقق على الجهاز والمتصفح الذي أنشأت محاولة عملية التسجيل منه',
        title: 'رابط التحقق غير صالح على هذا الجهاز',
      },
      formSubtitle: 'أستعمل رابط التحقق المرسل إلى بريدك الإلكتروني',
      formTitle: 'رابط التحقق',
  ...
  unstable__errors: {
    ...
    form_identifier_exists__email_address:
      'تم إستخدام البريد الإلكتروني هذا. يرجى المحاولة مرة أخرى',
    form_identifier_exists__phone_number:
      'تم إستخدام رقم الهاتف هذا. يرجى المحاولة مرة أخرى',
    form_identifier_exists__username:
      'تم إستخدام اسم المستخدمد هذا. يرجى المحاولة مرة أخرى',
    ...
    passkey_pa_not_supported:
      'يتطلب التسجيل أداة مصادقة النظام الأساسي ولكن الجهاز لا يدعمها',
    passkey_registration_cancelled:
      'تم إلغاء تسجيل مفتاح المرور أو انتهت مهلته',
